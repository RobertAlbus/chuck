...
Machine.add("Project/R2D16/echo.ck");
Machine.add("Project/R2D16/AdsrController.ck");
Machine.add("Project/R2D16/SingleOscSynth.ck");
Machine.add("Project/R2D16/source.ck");
